...
namespace ParkingLots.Infrastructure.Migrations
{
    ...
    [Migration("20211229135800_Initial_Migration")]
            ...
            modelBuilder.Entity("ParkingLots.Domain.Entities.Profile", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = new Guid("b6855d79-4563-49d4-ab7b-b103c4626a5c"),
                            CreatedAt = new DateTime(2021, 12, 29, 13, 58, 0, 459, DateTimeKind.Utc).AddTicks(8770),
                            Description = "Usuario con todos los permisos",
                            Name = "Administrators",
                            UpdatedAt = new DateTime(2021, 12, 29, 13, 58, 0, 459, DateTimeKind.Utc).AddTicks(8770)
                        },
                        new
                        {
                            Id = new Guid("9a51bd24-0778-4db3-bd09-dfb5929227cd"),
                            CreatedAt = new DateTime(2021, 12, 29, 13, 58, 0, 459, DateTimeKind.Utc).AddTicks(9180),
                            Description = "Usuario que tiene puede gestionar los parqueaderos",
                            Name = "Managers",
                            UpdatedAt = new DateTime(2021, 12, 29, 13, 58, 0, 459, DateTimeKind.Utc).AddTicks(9190)
                        },
                        new
                        {
                            Id = new Guid("28046bd6-c5ee-4575-96f4-5e236f426ead"),
                            CreatedAt = new DateTime(2021, 12, 29, 13, 58, 0, 459, DateTimeKind.Utc).AddTicks(9190),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2021, 12, 29, 13, 58, 0, 459, DateTimeKind.Utc).AddTicks(9200),
                            Description = "Usuario que puede ver todo dentro del backend pero sin poder realizar acción alguna",
                            Name = "ReadOnly",
                            UpdatedAt = new DateTime(2021, 12, 29, 13, 58, 0, 459, DateTimeKind.Utc).AddTicks(9200)
                        });
                });
            ...
            modelBuilder.Entity("ParkingLots.Domain.Entities.ProfilePermission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Id = new Guid("59e99267-9859-4ac3-bd22-5d4184c0c498")
                        },
                        new
                        {
                            ProfileId = new Guid("b6855d79-4563-49d4-ab7b-b103c4626a5c"),
                            PermissionId = new Guid("9a51bd24-0778-4db3-bd09-dfb5929227cd"),
                            Id = new Guid("e3217fc3-75c7-4ebb-8815-73ddc056c0b4")
                        },
                        new
                        {
                            ProfileId = new Guid("b6855d79-4563-49d4-ab7b-b103c4626a5c"),
                            PermissionId = new Guid("b970bb7d-422e-4354-8e1c-c40b111dec51"),
                            Id = new Guid("432c111e-07e0-4546-ab9b-04f244310217")
                        });
                });
